...
where normalization in 4.66 contracts the $\vert\phi(\bf{k})\vert^2$ in 4.74. 
...
\eqnum{
    ...
    \vert \\
    =& 1 / \vert\frac{\bar{k}_\mathcal{A}^z}{\bar{E}_\mathcal{A}} - \frac{\bar{k}_\mathcal{B}^z}{\bar{E}_\mathcal{B}}\vert
}
...
% we need LSZ reduction formula to switch from position- to momentum-
...
%     \begin{tikzpicture}
%         \begin{feynman}
%             \node[dot, label=above:\(z\)](z);
%             \node[dot, below left=2cm of z, label=left:\(x_\mathcal{A}\)](i1);
%             \node[dot, below right=2cm of z, label=right:\(x_\mathcal{B}\)](i2);
%             \node[dot, above left=2cm of z, label=left:\(x_1\)](f1);
%             \node[dot, above right=2cm of z, label=right:\(x_2\)](f2);
%             \node[dot, below right=1cm of z, label=left:\(w\)](w);
%             \vertex[right=1.414cm of z](w0);
%             \diagram*{
%                 (i1) -- (z),
%                 (i2) -- (w),
%                 (w) -- (z),
...
%         \begin{feynman}
%             \vertex (p);
%             \vertex[above left=2cm of p](f1);
%             \vertex[above right=2cm of p](f2);
%             \vertex[below left=2cm of p](i1);
%             \vertex[below right=2cm of p](i2);
%             \vertex[below right=1cm of p](k);
%             \vertex[right=1.414cm of p](k0);
%             \diagram*{
%                 (i1) --[fermion, edge label=\(p_\mathcal{A}\)] (p),
%                 (i2) --[fermion, edge label=\(p_\mathcal{B}\)] (k),
%                 (k) --[fermion, edge label=\(p^\prime\)] (p),
...
%     i1 [particle=\(\bar{\nu}_{e}\)] -- [anti fermion] a -- [anti fermion] i2 [particle=\(\bar{\nu}_{e}\)],
%     f1 [particle=\(e^{-}\)] -- [fermion] b -- [fermion] f2 [particle=\(e^{-}\)],
%     a -- [boson, edge label=\(Z^{0}\)] b,
% };

% \feynmandiagram[horizontal=a to b]{
%     i1 [particle=\(\bar{\nu}_{e}\)] -- [anti fermion] a -- [anti fermion] i2 [particle=\(e^{-}\)],
